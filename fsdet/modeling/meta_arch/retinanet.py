...
class RetinaNet(nn.Module):
    ...
    def get_ground_truth(self, anchors, targets):
        """
        Args:
            anchors (list[list[Boxes]]): a list of N=
                list of 
    ...
    def inference(self, box_cls, box_delta, anchors, images):
        ...
        Arguments:
            ...
            anchors (list[list[Boxes]]): a list of 
                list of 
                image on the specific feature level.
            images (ImageList): the input images

        Returns:
            results (List[Instances]): a list of 
        """
    ...
    def inference_single_image(self, box_cls, box_delta, anchors, image_size):
        ...
        Arguments:
            box_cls (list[Tensor]): list of 
                tensor of size (H x W x A, K)
            box_delta (list[Tensor]): Same shape as 'box_cls' except that K becomes 4.
            anchors (list[Boxes]): list of 
